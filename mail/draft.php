    ...
    <header class="bg-white shadow-md p-4">
        <div class="container mx-auto">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-semibold">Draft (Saved Mail)</h1>
        ...
        <div class="container mx-auto mt-4">
            ...
            <?php
                ...
                $callingDraft = mysqli_query($connect,"SELECT * FROM mail JOIN accounts ON mail.user_to = accounts.user_id WHERE user_by = '$myuserid' and isDraft='1'");
                while($row = mysqli_fetch_array($callingDraft)):
            ?>
